...
Player vs AI: Challenge the computer (includes smart move logic).

Real-time Score Tracking: Keeps track of X wins, O wins, and draws during the session.

Responsive UI: Built with Flet containers and rows for a smooth visual experience.
